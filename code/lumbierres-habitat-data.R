...
version <- "10.5281/zenodo.5146073-v2"
...
## download data
raw_path <- "data/habitat_CGLS.tif"
piggyback::pb_download(
  file = basename(raw_path),
  dest = dirname(raw_path),
  repo = "prioritizr/lumbierres-habitat-data",
  tag = "v0.0.1"
)
...
output_path <- file.path("results", paste0("lumbierres-", output_path, ".tif"))
